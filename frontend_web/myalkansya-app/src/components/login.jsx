...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post("https://it-342-my-alkansya-gilt.vercel.app/api/users/login", {
        email,
        password,
      });
  ...
  const handleGoogleLogin = () => {
    ...
    window.location.href = `https://it-342-my-alkansya-gilt.vercel.app/oauth2/authorization/google?redirect_uri=${encodeURIComponent(window.location.origin)}`;
  };

  const handleFacebookLogin = () => {
    localStorage.setItem("frontendRedirectUrl", window.location.origin);
    window.location.href = `https://it-342-my-alkansya-gilt.vercel.app/oauth2/authorization/facebook?redirect_uri=${encodeURIComponent(window.location.origin)}`;
  };

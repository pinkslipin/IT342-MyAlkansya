          ...
          <div className="bg-white p-12 rounded-lg shadow-md w-full max-w-7xl flex" style={{ height: "650px" }}>
            ...
            <div className="w-1/3 bg-[#F9F9F9] rounded-lg p-6 flex flex-col justify-center">
              <div className="bg-[#18864F] text-white p-4 rounded-lg mb-4">
                <h3 className="text-lg font-semibold">Income Editing Tips</h3>
                <ul className="list-disc ml-4 mt-2 text-sm">
                  <li>Keep your income sources descriptive for better tracking.</li>
                  <li>Editing the date will affect which month this income is reported in.</li>
                  <li>Use your default currency for consistency.</li>
                </ul>
              </div>
              <div className="bg-amber-50 border-l-4 border-amber-500 p-4 my-4">
                <h3 className="font-medium text-amber-800">Need to add new income?</h3>
                <button
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-4">
                ...
                <p className="text-sm text-blue-700 mt-2">
                  Regularly updating your income helps you see your true savings rate.
                </p>
              </div>
            </div>
          </div>
